...
const foot = (dark) => `<text x="100" y="830" font-family="IBM Plex Mono" font-weight="600" font-size="18" letter-spacing="3" fill="${dark ? MUTED_D : MUTED_L}">$FSL  ·  ROBINHOOD CHAIN  ·  @FantasyStocksRH</text>`;
