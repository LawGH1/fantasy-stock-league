...
const teaser = `<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900">
  ...
  <text x="100" y="820" font-family="IBM Plex Mono" font-weight="600" font-size="20" letter-spacing="3" fill="#7A8592">$FSL  ·  @FantasyStockRH</text>
</svg>`;
...
const howto = `<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900">
  ...
  <text x="100" y="820" font-family="IBM Plex Mono" font-weight="600" font-size="20" letter-spacing="3" fill="#7A8592">$FSL  ·  ROBINHOOD CHAIN  ·  @FantasyStockRH</text>
</svg>`;
